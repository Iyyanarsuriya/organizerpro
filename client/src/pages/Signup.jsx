      ...
      <div className="glass w-full max-w-sm sm:max-w-md p-6 sm:p-8 rounded-4xl shadow-2xl">
        <div className="flex flex-col items-center mb-8">
          <div className="relative w-20 h-20 mb-4">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-full animate-pulse shadow-lg shadow-emerald-500/30"></div>
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          ...
          {/* <div className="flex items-center gap-2 px-1 py-2">
            <input type="checkbox" id="terms" className="rounded-md border-slate-300 text-[#2d5bff] focus:ring-[#2d5bff]" required />
            <label htmlFor="terms" className="text-xs text-slate-400 font-semibold cursor-pointer">
