...
const EducationExpenseDashboard = ({
    periodType,
    customRange,
    currentPeriod,
    stats,
        ...
        <div className="animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-4 mb-4 sm:mb-8">
                <div className="bg-white p-6 sm:p-8 rounded-[32px] shadow-sm border border-slate-100 relative group overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full">
                        ...
                        <div className="h-[8px] mt-4 flex items-center gap-1">
                            ...
                            <span className="text-[6px] font-black text-blue-400 uppercase tracking-tighter">FEES & REVENUE</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 sm:p-8 rounded-[32px] shadow-sm border border-slate-100 relative group overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full">
                        ...
                        <div className="h-[8px] mt-4 flex items-center gap-1">
                            ...
                            <span className="text-[6px] font-black text-rose-400 uppercase tracking-tighter">OPERATIONAL COSTS</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-slate-900 p-6 sm:p-8 rounded-[32px] shadow-xl border border-slate-800 relative group overflow-hidden xs:col-span-2 lg:col-span-1">
                    ...
                    <div className="relative z-10 flex flex-col justify-between h-full">
                        <div>
                            <p className="text-[8px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1">Net Education Fund</p>
                            <h3 className={`text-3xl font-black tracking-tight ${(stats.summary?.total_income - stats.summary?.total_expense) >= 0 ? 'text-emerald-400' : 'text-rose-400'}`}>
                                ₹{formatAmount(stats.summary?.total_income - stats.summary?.total_expense)}
                            </h3>
                        </div>
                        <div className="h-[8px] mt-4 flex items-center gap-1">
                            <div className={`w-1.5 h-1.5 rounded-full animate-pulse ${(stats.summary?.total_income - stats.summary?.total_expense) >= 0 ? 'bg-emerald-400' : 'bg-rose-400'}`}></div>
                            <span className="text-[6px] font-black text-slate-500 uppercase tracking-tighter">CURRENT BALANCE</span>
                        </div>
                    </div>
                </div>
            </div>
...
export default EducationExpenseDashboard;
