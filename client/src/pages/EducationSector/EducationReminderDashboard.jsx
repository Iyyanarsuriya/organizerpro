        ...
        <div className="min-h-screen bg-[#f8fafc] p-4 sm:p-8 font-['Outfit']">
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                <div className="flex items-center justify-between">
                    <button
                        onClick={() => navigate('/education-sector/reminders')}
                ...
                <div className="bg-white rounded-[24px] p-4 sm:p-6 shadow-lg shadow-slate-200/50 border border-slate-100 flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <ExportButtons
                            onExportCSV={() => exportReminderToCSV({ data: processedReminders, period: exportPeriod, filename: `edu_reminders_report_${new Date().toISOString().split('T')[0]}` })}
                            onExportPDF={() => exportReminderToPDF({ data: processedReminders, period: exportPeriod, filename: `edu_reminders_report_${new Date().toISOString().split('T')[0]}` })}
                            onExportTXT={() => exportReminderToTXT({ data: processedReminders, period: exportPeriod, filename: `edu_reminders_report_${new Date().toISOString().split('T')[0]}` })}
                        />
                    </div>
                </div>
...
export default EducationReminderDashboard;
