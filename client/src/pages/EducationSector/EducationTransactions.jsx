...
import { FaPlus, FaEdit, FaTrash, FaExchangeAlt, FaSearch, FaFilter, FaCalendarAlt, FaUser, FaTag } from 'react-icons/fa';
            ...
            <div className="bg-white/80 backdrop-blur-xl p-6 rounded-[32px] border border-white/20 shadow-xl shadow-slate-200/50 mb-8 sticky top-4 z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-6">
                    <div>
                        ...
                        <p className="text-sm font-medium text-slate-400 mt-1">Manage and track Education financials</p>
                    </div>
...
export default EducationTransactions;
