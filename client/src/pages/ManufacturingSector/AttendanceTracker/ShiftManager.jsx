    ...
    return (
        <div className="bg-white rounded-[20px] sm:rounded-3xl p-[16px] sm:p-8 shadow-sm border border-slate-100">
            ...
            <div className="flex items-center gap-[10px] sm:gap-3 mb-[20px] sm:mb-8">
                ...
                <div>
                    <h3 className="text-[16px] sm:text-lg font-black text-slate-900">Shifts &amp; Rules</h3>
                    <p className="text-[10px] sm:text-xs font-bold text-slate-400">Configure working hours</p>
                </div>
            </div>
