    ...
    <div className="glass w-full min-h-full p-[24px] sm:p-[40px] relative">
      ...
      <div className="flex flex-col items-center mb-8">
        <div className="relative w-20 h-20 mb-4">
          <div className="absolute inset-0 bg-linear-to-br from-[#2d5bff] to-[#1a3dbf] rounded-2xl rotate-45 animate-pulse"></div>
      ...
      <form onSubmit={handleSignIn} className="space-y-6">
        ...
        <div className="flex justify-between items-center px-1">
          ...
          <Link to="/forgot-password" onClick={onClose} className="text-xs text-[#2d5bff] font-bold hover:underline">Forgot password?</Link>
        </div>
