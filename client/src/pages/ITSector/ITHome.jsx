        ...
        <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-[20px] sm:p-[40px] font-['Outfit']">
            <div className="max-w-[1280px] mx-auto w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-[20px] sm:gap-[32px] justify-center max-w-[1200px] mx-auto">
                    ...
                    {/* Reminders Card */}
                    <Link to="/it/reminders" className="group flex flex-col items-center justify-center p-[32px] sm:p-[40px] rounded-[32px] sm:rounded-[40px] bg-blue-50/50 hover:bg-blue-50 border border-blue-100/50 hover:border-blue-200 transition-all duration-300 hover:-translate-y-[8px] hover:shadow-2xl hover:shadow-blue-500/20 active:scale-95">
                    ...
                    {/* Attendance Card */}
                    <Link to="/it/attendance" className="group flex flex-col items-center justify-center p-[32px] sm:p-[40px] rounded-[32px] sm:rounded-[40px] bg-orange-50/50 hover:bg-orange-50 border border-orange-100/50 hover:border-orange-200 transition-all duration-300 hover:-translate-y-[8px] hover:shadow-2xl hover:shadow-orange-500/20 active:scale-95">
                    ...
                    <Link to="/it/team" className="group flex flex-col items-center justify-center p-[32px] sm:p-[40px] rounded-[32px] sm:rounded-[40px] bg-purple-50/50 hover:bg-purple-50 border border-purple-100/50 hover:border-purple-200 transition-all duration-300 hover:-translate-y-[8px] hover:shadow-2xl hover:shadow-purple-500/20 active:scale-95">
