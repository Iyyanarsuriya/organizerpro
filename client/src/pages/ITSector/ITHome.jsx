            ...
            <div className="max-w-[1280px] mx-auto w-full">
                ...
                <div className="text-center mb-[40px] sm:mb-[64px]">
                    <h1 className="text-[32px] sm:text-[48px] font-black text-slate-800 tracking-tight mb-[16px]">
                        IT Sector <span className="text-blue-600">Hub</span>
                    </h1>
                    <p className="text-slate-500 font-medium text-[14px] sm:text-[16px]">Select a module to manage your IT workflow</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-[20px] sm:gap-[32px] justify-center max-w-[1200px] mx-auto">

                    {/* Reminders Card */}
                    <Link to="/it-sector/reminders" className="group flex flex-col items-center justify-center p-[32px] sm:p-[40px] rounded-[32px] sm:rounded-[40px] bg-blue-50/50 hover:bg-blue-50 border border-blue-100/50 hover:border-blue-200 transition-all duration-300 hover:-translate-y-[8px] hover:shadow-2xl hover:shadow-blue-500/20 active:scale-95">
                    ...
                    {/* Attendance Card */}
                    <Link to="/it-sector/attendance" className="group flex flex-col items-center justify-center p-[32px] sm:p-[40px] rounded-[32px] sm:rounded-[40px] bg-orange-50/50 hover:bg-orange-50 border border-orange-100/50 hover:border-orange-200 transition-all duration-300 hover:-translate-y-[8px] hover:shadow-2xl hover:shadow-orange-500/20 active:scale-95">
                    ...
                    <Link to="/it-sector/team" className="group flex flex-col items-center justify-center p-[32px] sm:p-[40px] rounded-[32px] sm:rounded-[40px] bg-purple-50/50 hover:bg-purple-50 border border-purple-100/50 hover:border-purple-200 transition-all duration-300 hover:-translate-y-[8px] hover:shadow-2xl hover:shadow-purple-500/20 active:scale-95">
                    ...
                    {/* Expense Tracker Card (New) */}
                    <Link to="/it-sector/expenses" className="group flex flex-col items-center justify-center p-[32px] sm:p-[40px] rounded-[32px] sm:rounded-[40px] bg-emerald-50/50 hover:bg-emerald-50 border border-emerald-100/50 hover:border-emerald-200 transition-all duration-300 hover:-translate-y-[8px] hover:shadow-2xl hover:shadow-emerald-500/20 active:scale-95">
