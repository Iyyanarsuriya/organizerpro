...
const ITReports = ({
    ...
    // Calculate Project Expenses for Pie Chart or Report
    const projectExpenses = React.useMemo(() => {
        return transactions
            .filter(t => t.type === 'expense' && t.project_id)
            .reduce((acc, t) => {
                acc[t.project_id] = (acc[t.project_id] || 0) + parseFloat(t.amount);
                return acc;
            }, {});
    }, [transactions]);
                                        ...
                                        <div className="flex items-center gap-4 mb-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="h-[8px] flex items-center gap-1">
                                                    ...
                                                    <span className="text-[6px] font-black text-slate-400 uppercase tracking-tighter">IT STAFF</span>
                                                </div>
                                            </div>
                                        </div>
