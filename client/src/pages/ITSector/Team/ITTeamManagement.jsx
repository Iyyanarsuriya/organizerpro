            ...
            <div className="max-w-7xl mx-auto px-[16px] sm:px-[24px] lg:px-[32px] py-[40px]">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-[32px] gap-[16px]">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-[28px] sm:text-[32px] font-black text-slate-800 tracking-tight leading-tight">IT Team Management</h1>
                            <p className="text-slate-500 mt-[4px] text-[14px]">Manage access for your IT organization</p>
                        </div>
                    </div>
                    <button
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white w-full max-w-md rounded-3xl p-8 shadow-2xl animate-fade-in relative">
                        <h2 className="text-2xl font-black text-slate-800 mb-6">Add IT Team Member</h2>
...
export default ITTeamManagement;
