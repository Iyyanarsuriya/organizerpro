            ...
            <div className="bg-white rounded-[40px] p-[32px] sm:p-[48px] w-full max-w-[550px] shadow-2xl relative animate-in zoom-in-95 duration-300 z-110">
                ...
                <form onSubmit={handleSubmit} className="mb-8 p-6 bg-slate-50 rounded-[24px] border border-slate-100">
                    <div className="space-y-4">
                        <div>
                            <label className="block text-[8px] sm:text-[9px] md:text-[10px] font-black text-slate-400 uppercase tracking-widest mb-[4px] sm:mb-[6px] md:mb-[7px] ml-[4px] sm:ml-[6px] md:ml-[7px]">Role / Designation Name</label>
                            <input
                                type="text"
                                value={newRoleName}
                                onChange={(e) => setNewRoleName(e.target.value)}
                                placeholder="Chef, Receptionist, Manager..."
                ...
                <div className="max-h-[300px] overflow-y-auto space-y-3 custom-scrollbar">
                    {roles.length > 0 ? (roles.map(role => (
                        ...
                        <p className="text-center text-slate-400 text-xs font-bold py-8 uppercase tracking-widest">No designations found</p>
                    )}
                </div>
                ...
                <ConfirmModal
                    ...
                    message="This will remove it from the list. Existing members with this designation will remain unchanged."
